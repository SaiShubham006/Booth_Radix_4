...
set_property PACKAGE_PIN V2 [get_ports {multiplicand[7]}]
set_property PACKAGE_PIN T3 [get_ports {multiplicand[6]}]
set_property PACKAGE_PIN T2 [get_ports {multiplicand[5]}]
set_property PACKAGE_PIN R3 [get_ports {multiplicand[4]}]
set_property PACKAGE_PIN W2 [get_ports {multiplicand[3]}]
set_property PACKAGE_PIN U1 [get_ports {multiplicand[2]}]
set_property PACKAGE_PIN T1 [get_ports {multiplicand[1]}]
set_property PACKAGE_PIN R2 [get_ports {multiplicand[0]}]
set_property PACKAGE_PIN V17 [get_ports {multiplier[7]}]
set_property PACKAGE_PIN V16 [get_ports {multiplier[6]}]
set_property PACKAGE_PIN W16 [get_ports {multiplier[5]}]
set_property PACKAGE_PIN W17 [get_ports {multiplier[4]}]
set_property PACKAGE_PIN W15 [get_ports {multiplier[3]}]
set_property PACKAGE_PIN V15 [get_ports {multiplier[2]}]
set_property PACKAGE_PIN W14 [get_ports {multiplier[1]}]
set_property PACKAGE_PIN W13 [get_ports {multiplier[0]}]
set_property PACKAGE_PIN U16 [get_ports {product[15]}]
set_property PACKAGE_PIN E19 [get_ports {product[14]}]
set_property PACKAGE_PIN U19 [get_ports {product[13]}]
set_property PACKAGE_PIN V19 [get_ports {product[12]}]
set_property PACKAGE_PIN W18 [get_ports {product[11]}]
set_property PACKAGE_PIN U15 [get_ports {product[10]}]
set_property PACKAGE_PIN U14 [get_ports {product[9]}]
set_property PACKAGE_PIN V14 [get_ports {product[8]}]
set_property PACKAGE_PIN V13 [get_ports {product[7]}]
set_property PACKAGE_PIN V3 [get_ports {product[6]}]
set_property PACKAGE_PIN W3 [get_ports {product[5]}]
set_property PACKAGE_PIN U3 [get_ports {product[4]}]
set_property PACKAGE_PIN P3 [get_ports {product[3]}]
set_property PACKAGE_PIN N3 [get_ports {product[2]}]
set_property PACKAGE_PIN P1 [get_ports {product[1]}]
set_property PACKAGE_PIN L1 [get_ports {product[0]}]
